    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.right}>
          <a href="#" className={styles.socialIcon} aria-label="GitHub" target="_blank" rel="noopener noreferrer">
          ...
          <a href="#" className={styles.socialIcon} aria-label="Twitter / X" target="_blank" rel="noopener noreferrer">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
